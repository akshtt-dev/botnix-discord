...
//     .setName("create-prem-server")
//     .setDescription("Create a new server on the premium node")
...
//     const NODE_ID = client.config.PTERODACTYL_PANEL.premNodeId;
//     if (!NODE_ID) {
//       return interaction.editReply(
//         "❌ Premium node ID is not configured. Please contact the server admin."
//       );
//     }
